...
Although all grading is characterized by an inherent opacity (if only for the simple reason that every presentation pertains to different material and takes place in a different session), here are some simple rules:
